...
public class StoreDetailProductAdapter extends RecyclerView.Adapter<StoreDetailProductAdapter.ViewHolder> {
    ...
    public StoreDetailProductAdapter(Context mRootContext, List<Product> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.store_detail_list_product_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View itemView) {
            ...
            product_item = itemView.findViewById(R.id.item_bookmark_all);
